...
class TestModels(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # brute marginalized over inclination and polarization together,
        # measured with 200000 samples
        cls.a4 = 541.2686
    ...
    def incpol_marg_model(self, **kwargs):
        """ Single template marginalized over inclination and polarization """
        static = self.static.copy()
        static.pop('polarization', None)
        ...
        return models.SingleTemplate(
                        ...
                        prior=prior,
                        marginalize_vector_samples=1000,
                        marginalize_vector_params='inclination,polarization',
                        **kwargs)
